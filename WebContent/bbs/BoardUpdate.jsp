...
<body>
<% 
Board b = (Board)application.getAttribute("view");
String title = b.getTitle();
String content = b.getContent();
int num = (int)b.getBoardnum();
%>
<form method="post" action="BoardServlet?action=writeUpdate">
<table>
    ...
    <tr> <td>제목</td> <td><input class="title" type="text" name="title" value="<%=title%>"></td></tr>
    <tr> <td height="500px">내용</td> <td><textarea name="content" id="" cols="30" rows="10" ><%=content%></textarea></td></tr>
</table >
